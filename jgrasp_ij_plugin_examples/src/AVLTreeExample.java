...
/**
 * AVLTreeExample - This example is intended to illustrate the capabilities of
 * the animating binary tree viewer in jGRASP when applied to an AVL tree.
 *
 ...
 *
 * To see AVL rotations "all at once", "End" the program. Set a breakpoint on
 * the line that starts with "avl_tree.add". Click the "Debug" button and then
 * "Resume" repeatedly.
 *
